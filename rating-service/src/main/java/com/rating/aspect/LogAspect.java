...
//    }
    ...
    public Object logAround(ProceedingJoinPoint joinPoint) throws Throwable {
        ...
        logDao.save(logInfo(joinPoint, log, request));
        return result;
    }
    ...
    public void logAfterThrowing(JoinPoint joinPoint, Throwable e) {
        ...
        HttpServletRequest request = RequestHolder.getHttpServletRequest();
        logDao.save(logInfo((ProceedingJoinPoint) joinPoint, log, request));
    }
    ...
    public Log logInfo(ProceedingJoinPoint joinPoint, Log log, HttpServletRequest request) {
        ...
        //反射Log对象
        com.citic.common.annotation.Log aopLog = method.getAnnotation(com.citic.common.annotation.Log.class);
        //获取ip
